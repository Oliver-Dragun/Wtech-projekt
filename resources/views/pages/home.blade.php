...
<main>
  ...
  <div class="container my-4">
    <div class="row g-3">
      @if($featuredBundle)
      <section class="col-12 col-lg-8" aria-label="Featured bundle">
      ...
      <aside class="col-12 col-lg-4 d-flex flex-column gap-3" style="min-height: 100%" aria-label="Side offers">
  ...
  <section class="container my-5" aria-label="New products">
